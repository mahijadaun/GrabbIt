...
import { assets } from "../greencart_assets/greencart_assets/assets.js";
const Cart = () => {
  ...
  const getCart = () => {
    ...
    for (const key in cartItems) {
      ...
      if (product) {
        ...
        console.warn(`No product found for cart item with key: ${key}`);
      }
    }
    ...
    try {
      ...
      if (paymentOption === "COD") {
        ...
        if (data.success) {
          ...
          navigate('/my-orders'); // This should navigate to "My Orders"
        } else {
          toast.error(data.message);
        }
      }else{
    ...
    <div className="flex flex-col md:flex-row mt-16">
        <div className='flex-1 max-w-4xl'>
                        ...
                        <div>
                            ...
                            <div className="font-normal text-gray-500/70">
                                ...
                                <div className='flex items-center'>
                                    ...
                                    {Array.from({ length: Math.max(Number(cartItems[product._id]) || 1, 9) }).map((_, index) => (
            ...
            <button onClick={() => {navigate("/products"); scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                <img className="group-hover:-translate-x-1 transition" src={assets.arrow_right_icon_colored} alt="arrow_right_icon_colored" />
                Continue Shopping
            </button>
