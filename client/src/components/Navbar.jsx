    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {/* Seller Login Button */}
                <button onClick={() => 
                navigate('/seller')} className="cursor-pointer px-6 py-2 border border-primary text-primary rounded-full hover:bg-primary hover:text-white transition">
                    Seller Login
                </button>
            ...
            {open && (
                <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden">
                    ...
                    {/* Mobile Seller Login Button */}
                    <button onClick={() => {
                        // setIsSeller(true);
                        navigate('/seller')
                    }} className="cursor-pointer px-6 py-2 mt-2 border border-primary text-primary rounded-full hover:bg-primary hover:text-white transition text-sm">
                        Seller Login
                    </button>
